    ...
    <div class="wrapper">
        ...
        <nav id="sidebar">
            ...
            <ul class="list-unstyled components">
                ...
                <li class="bg-primary">
                    <a href="users.php" class="dashboard"><i class="material-icons" style="color:#fff">dashboard</i><span class="text-light">Utilisateurs</span></a>
                </li>
                <li class="active">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            foreach ($data as $users => $user) {
                                                ...
                                                <td>$date</td>
                                                <td>$scan</td>
                                                <td><a href='valider.php?key=$id' class='btn btn-success'>Voir Plus</a></td>
                                                </tr>
